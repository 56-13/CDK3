...
{
    public partial class GradientLineSpriteElementControl : UserControl, ICollapsibleControl, ISplittableControl
    {
        private SpriteElementGradientLine _Element;

        [Browsable(false)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public SpriteElementGradientLine Element
        {
            set
            {
                if (_Element != value)
        ...
        public GradientLineSpriteElementControl()
        {
            InitializeComponent();
        }
