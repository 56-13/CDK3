...
{
    public partial class ArcSpriteElementControl : UserControl, ICollapsibleControl, ISplittableControl
    {
        private SpriteElementArc _Element;

        [Browsable(false)]
        [DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)]
        public SpriteElementArc Element
        {
            set
            {
                if (_Element != value)
        ...
        public ArcSpriteElementControl()
        {
            InitializeComponent();
