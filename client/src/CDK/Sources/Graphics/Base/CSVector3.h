...
struct CSVector3 {
    ...
    CSVector3() = default;
    inline explicit CSVector3(float v) : x(v), y(v), z(v) {}
    inline CSVector3(float x, float y, float z) : x(x), y(y), z(z) {}
    inline CSVector3(const CSVector2& other, float z = 0) : x(other.x), y(other.y), z(z) {}
    
    explicit CSVector3(CSBuffer* buffer);
    explicit CSVector3(const byte*& raw);
    ...
    static void cross(const CSVector3& left, const CSVector3& right, CSVector3& result);
    ...
    static bool nearEqual(const CSVector3& a, const CSVector3& b);

    inline bool nearEqual(const CSVector3& other) const {
