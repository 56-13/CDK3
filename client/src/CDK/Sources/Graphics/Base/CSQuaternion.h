...
struct CSQuaternion {
    ...
    explicit CSQuaternion(CSBuffer* buffer);
    explicit CSQuaternion(const byte*& bytes);
    ...
    static bool nearEqual(const CSQuaternion& a, const CSQuaternion& b);

    inline bool nearEqual(const CSQuaternion& other) const {
