...
struct CSVector2 {
    ...
    static const CSVector2 UnitX;
    static const CSVector2 UnitY;
    static const CSVector2 One;
    
    CSVector2() = default;
    inline explicit CSVector2(float v) : x(v), y(v) {}
    inline CSVector2(float x, float y) : x(x), y(y) {}
    
    explicit CSVector2(CSBuffer* buffer);
    explicit CSVector2(const byte*& raw);
    ...
    static bool nearEqual(const CSVector2& a, const CSVector2& b);

    inline bool nearEqual(const CSVector2& other) const {
