...
struct CSVector4 {
    ...
    static const CSVector4 UnitX;
    static const CSVector4 UnitY;
    static const CSVector4 UnitZ;
    static const CSVector4 UnitW;
    static const CSVector4 One;
    
    CSVector4() = default;
    inline explicit CSVector4(float v) : x(v), y(v), z(v), w(v) {}
    ...
    explicit CSVector4(CSBuffer* buffer);
    explicit CSVector4(const byte*& raw);
    ...
    static bool nearEqual(const CSVector4& a, const CSVector4& b);

    inline bool nearEqual(const CSVector4& other) const {
