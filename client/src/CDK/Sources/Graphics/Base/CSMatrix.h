...
struct CSMatrix {
    ...
    CSMatrix(float m11, float m12, float m13, float m14,
             float m21, float m22, float m23, float m24,
             float m31, float m32, float m33, float m34,
             float m41, float m42, float m43, float m44);

    explicit CSMatrix(CSBuffer* buffer);
    explicit CSMatrix(const byte*& raw);
    ...
    bool decompose(CSVector3& scale, CSQuaternion& rotation, CSVector3& trans) const;
    bool decomposeUniformScale(float& scale, CSQuaternion& rotation, CSVector3& trans) const;
    ...
    static inline CSMatrix transpose(const CSMatrix& matrix) {
        CSMatrix result;
    ...
    static inline CSMatrix invert(const CSMatrix& matrix) {
        CSMatrix result;
    ...
    static bool nearEqual(const CSMatrix& a, const CSMatrix& b);

    inline bool nearEqual(const CSMatrix& other) const {
