...
CSString* CSEncoder::createStringWithBytes(const void* bytes, int length, CSStringEncoding encoding) {
...
void* CSEncoder::createRawWithString(const char* str, int& length, CSStringEncoding encoding) {
	NSStringEncoding nsencoding;
