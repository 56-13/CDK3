...
const char* CSTextFieldBridge::placeholder(void* handle) {
...
void CSTextFieldBridge::setPlaceholder(void* handle, const char* placeholder) {
	static_cast<CSTextFieldHandle*>(handle)->setPlaceholder(string(placeholder));
}
...
int CSTextFieldBridge::maxLength(void* handle) {
	return static_cast<CSTextFieldHandle*>(handle)->maxLength();
}

void CSTextFieldBridge::setMaxLength(void* handle, int maxLength) {
	static_cast<CSTextFieldHandle*>(handle)->setMaxLength(maxLength);
}

int CSTextFieldBridge::maxLine(void* handle) {
	return static_cast<CSTextFieldHandle*>(handle)->maxLine();
}

void CSTextFieldBridge::setMaxLine(void* handle, int maxLine) {
