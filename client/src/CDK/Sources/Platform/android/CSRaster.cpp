...
CSSize CSRaster::characterSize(const uchar* cc, int cclen, const CSFont* font) {
	CSJNIMethod mi;
...
void* CSRaster::createRasterFromCharacter(const uchar* cc, int cclen, const CSFont* font, int& width, int& height, float& offy) {
	void* raster = NULL;
	CSJNIMethod mi;
...
void* CSRaster::createRasterFromImageSource(const void* source, int len, int& width, int& height) {
	void* raster = NULL;
	CSJNIMethod mi;
...
bool CSRaster::saveImageFromRaster(const char* path, const void* raster, int width, int height) {
    CSJNIMethod mi;
